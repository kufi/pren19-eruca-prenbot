...
*/
/*
void US_HeckListener_Enable(void)

**  This method is implemented as a macro. See US_HeckListener.h file.  **
*/
...
*/
/*
void US_HeckListener_Disable(void)
...
*/
/*
bool US_HeckListener_GetVal(void)
...
/*
** ===================================================================
**     Method      :  US_HeckListener_OnInterrupt (component ExtInt)
**
**     Description :
...
void ExtIntLdd4_OnInterrupt(LDD_TUserData *UserDataPtr)
{
  ...
  US_HeckListener_OnInterrupt();       /* Invoke OnInterrupt event */
}
