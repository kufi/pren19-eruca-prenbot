...
** ###################################################################*/
  ...
  __attribute__ ((section (".vectortable"))) const tVectorTable __vect_table = { /* Interrupt vector table */
    ...
    (tIsrFunc)&RegelungReferenztimer_Interrupt, /* 0x0F  0x0000003C   2   ivINT_SysTick                 used by PE */
    ...
    (tIsrFunc)&I2cSlave_Interrupt,     /* 0x18  0x00000060   2   ivINT_I2C0                    used by PE */
    (tIsrFunc)&I2C_Kompass_Interrupt,  /* 0x19  0x00000064   2   ivINT_I2C1                    used by PE */
    ...
    (tIsrFunc)&EncoderRefrenztimer_Interrupt, /* 0x21  0x00000084   2   ivINT_TPM0                    used by PE */
    (tIsrFunc)&Cpu_Interrupt,          /* 0x22  0x00000088   -   ivINT_TPM1                    unused by PE */
    (tIsrFunc)&US_Referenztimer_Interrupt, /* 0x23  0x0000008C   2   ivINT_TPM2                    used by PE */
