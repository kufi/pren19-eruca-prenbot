...
static ExtIntLdd4_TDeviceData * INT_PORTA__DEFAULT_RTOS_ISRPARAM;
...
LDD_TDeviceData* ExtIntLdd4_Init(LDD_TUserData *UserDataPtr)
{
  ...
  PORTA_ISFR = PORT_ISFR_ISF(0x00010000);                                                   
  /* Initialization of Port Control registers */
  /* PORTA_PCR16: ISF=0,IRQC=0,MUX=1 */
...
{
  ExtIntLdd4_TDeviceData *DeviceDataPrv = (ExtIntLdd4_TDeviceData *)DeviceDataPtr;
  PORT_PDD_ClearPinInterruptFlag(ExtIntLdd4_PORTCONTROL_BASE_ADDRESS, ExtIntLdd4_PIN_INDEX);
  PORT_PDD_SetPinInterruptConfiguration(ExtIntLdd4_PORTCONTROL_BASE_ADDRESS,\
                                        ExtIntLdd4_PIN_INDEX, ExtIntLdd4_IRQ_CONFIG);
...
void ExtIntLdd4_Interrupt(void)
{
  ...
  ExtIntLdd4_TDeviceDataPtr DeviceDataPrv = INT_PORTA__DEFAULT_RTOS_ISRPARAM;
  ...
  if (PORT_PDD_GetPinInterruptFlag(ExtIntLdd4_PORTCONTROL_BASE_ADDRESS, ExtIntLdd4_PIN_INDEX)) {
...
bool ExtIntLdd4_GetVal(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  if ((GPIO_PDD_GetPortDataInput(ExtIntLdd4_MODULE_BASE_ADDRESS) & ExtIntLdd4_PIN_MASK) != 0U) {
    return TRUE;
  }
  else {
    return FALSE;
