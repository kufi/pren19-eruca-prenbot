...
**          Period                                         : 320 Hz
**          Starting pulse width                           : 0.047684 µs
...
#define PwmLdd1_PERIOD_VALUE_0 0x00UL  /* Period value in ticks of the timer in clock configuration 0. It is available only if the bean is enabled in clock configuration 0. */
