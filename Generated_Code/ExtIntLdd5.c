...
static ExtIntLdd5_TDeviceData * INT_PORTD__DEFAULT_RTOS_ISRPARAM;
...
{
  ExtIntLdd5_TDeviceData *DeviceDataPrv = (ExtIntLdd5_TDeviceData *)DeviceDataPtr;
  PORT_PDD_ClearPinInterruptFlag(ExtIntLdd5_PORTCONTROL_BASE_ADDRESS, ExtIntLdd5_PIN_INDEX);
  PORT_PDD_SetPinInterruptConfiguration(ExtIntLdd5_PORTCONTROL_BASE_ADDRESS,\
                                        ExtIntLdd5_PIN_INDEX, ExtIntLdd5_IRQ_CONFIG);
...
void ExtIntLdd5_Interrupt(void)
{
  ...
  ExtIntLdd5_TDeviceDataPtr DeviceDataPrv = INT_PORTD__DEFAULT_RTOS_ISRPARAM;
  ...
  if (PORT_PDD_GetPinInterruptFlag(ExtIntLdd5_PORTCONTROL_BASE_ADDRESS, ExtIntLdd5_PIN_INDEX)) {
...
bool ExtIntLdd5_GetVal(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  if ((GPIO_PDD_GetPortDataInput(ExtIntLdd5_MODULE_BASE_ADDRESS) & ExtIntLdd5_PIN_MASK) != 0U) {
    return TRUE;
  }
  else {
    return FALSE;
