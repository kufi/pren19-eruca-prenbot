...
*/
/*
bool Stop_GetVal(void)

**  This method is implemented as a macro. See Stop.h file.  **
*/

/*
** ===================================================================
**     Method      :  Stop_OnInterrupt (component ExtInt)
**
**     Description :
...
void ExtIntLdd9_OnInterrupt(LDD_TUserData *UserDataPtr)
{
  ...
  Stop_OnInterrupt();                  /* Invoke OnInterrupt event */
}
