...
PE_ISR(Cpu_ivINT_PORTD)
{
  ...
  ExtIntLdd8_Interrupt();              /* Call the service routine */
  ExtIntLdd9_Interrupt();              /* Call the service routine */
}
...
void PE_low_level_init(void)
{
  ...
  /* GPIOD_PDDR: PDD&=~0xDF */
  GPIOD_PDDR &= (uint32_t)~(uint32_t)(GPIO_PDDR_PDD(0xDF));                                                   
  ...
  /* ### TimerUnit_LDD "EncoderRefrenztimer" component auto initialization. Auto initialization feature can be disabled by component property "Auto initialization". */
  (void)EncoderRefrenztimer_Init(NULL);
  ...
  /* ### TimerUnit_LDD "RegelungReferenztimer" component auto initialization. Auto initialization feature can be disabled by component property "Auto initialization". */
  (void)RegelungReferenztimer_Init(NULL);
  /* ### TimerUnit_LDD "US_Referenztimer" component auto initialization. Auto initialization feature can be disabled by component property "Auto initialization". */
  (void)US_Referenztimer_Init(NULL);
  ...
  /* ### ExtInt_LDD "ExtIntLdd6" component auto initialization. Auto initialization feature can be disabled by component property "Auto initialization". */
  ...
  /* ### ExtInt_LDD "ExtIntLdd8" component auto initialization. Auto initialization feature can be disabled by component property "Auto initialization". */
  (void)ExtIntLdd8_Init(NULL);
  /* ### ExtInt_LDD "ExtIntLdd9" component auto initialization. Auto initialization feature can be disabled by component property "Auto initialization". */
  (void)ExtIntLdd9_Init(NULL);
