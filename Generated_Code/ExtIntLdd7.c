...
} ExtIntLdd7_TDeviceData, *ExtIntLdd7_TDeviceDataPtr; /* Device data structure type */

/* {Default RTOS Adapter} Static object used for simulation of dynamic driver memory allocation */
static ExtIntLdd7_TDeviceData DeviceDataPrv__DEFAULT_RTOS_ALLOC;
/* {Default RTOS Adapter} Global variable used for passing a parameter into ISR */
static ExtIntLdd7_TDeviceData * INT_PORTD__DEFAULT_RTOS_ISRPARAM;
...
bool ExtIntLdd7_GetVal(LDD_TDeviceData *DeviceDataPtr)
{
  ...
  if ((GPIO_PDD_GetPortDataInput(ExtIntLdd7_MODULE_BASE_ADDRESS) & ExtIntLdd7_PIN_MASK) != 0U) {
    return TRUE;
  }
  else {
    return FALSE;
